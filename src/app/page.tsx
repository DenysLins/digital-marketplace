...
const perks = [
  {
    ...
    description:
      'Get your products delivered to your email in seconds and download them right away.',
  },
  {
    name: 'Guaranteed Quality',
    Icon: CheckCircle,
    description:
      'Every product on our platform is verified by our team to ensure our highest quality standards. Not happy with your purchase? Get a refund within 30 days.',
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
    ...
    <>
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="text-4xl font-bold tracking- text-gray-900 sm:text-6xl">
            Your marketplace for hight-quality{' '}
            <span className="text-blue-600">digital products</span>.
          </h1>
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to Digital Marketplace. Every product on our platform is
